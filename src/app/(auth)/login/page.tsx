        ...
        <>
            ...
            <nav className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-10">
                ...
                <div className="flex items-center gap-4">
                    <span className="text-sm font-medium text-slate-500 hidden sm:block">Don&apos;t have an account?</span>
                    <Link href="/register" className="text-sm font-semibold text-primary hover:text-blue-600 transition-colors">
                        Sign Up
                    </Link>
                </div>
            </nav>
                ...
                <div className="w-full max-w-[480px] bg-white dark:bg-surface-dark rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-slate-200 dark:border-slate-700 relative z-20 overflow-hidden">
                    <div className="p-8 sm:p-10 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-3 text-center">
                            ...
                            <h1 className="text-3xl font-black leading-tight tracking-[-0.033em]">Welcome Back</h1>
                        ...
                        <form action={formAction} className="flex flex-col gap-6">
                            ...
                            <label className="flex flex-col gap-2">
                                <span className="text-base font-medium text-slate-700 dark:text-slate-200">Email Address</span>
                            ...
                            <label className="flex flex-col gap-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link href="/forgot-password" className="text-sm font-medium text-primary hover:text-blue-600">
                                        Forgot password?
                                    </Link>
                                </div>
                                <div className="relative group">
